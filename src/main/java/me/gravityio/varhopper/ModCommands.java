...
public class ModCommands {
    ...
    public static LiteralArgumentBuilder<ServerCommandSource> build() {
        ...
        var hyperHopper = buildInt("hyper_cooldown", () -> ModConfig.INSTANCE.hyperCooldown, v -> ModConfig.INSTANCE.hyperCooldown = v, ModConfig.INSTANCE::save);
        var superHopper = buildInt("super_cooldown", () -> ModConfig.INSTANCE.superCooldown, v -> ModConfig.INSTANCE.superCooldown = v, ModConfig.INSTANCE::save);
        ...
        root.executes(context -> {
            ...
            s.sendFeedback(() -> Text.translatable("command.varhopper.get_int", "hyper_cooldown", ModConfig.INSTANCE.hyperCooldown), false);
            s.sendFeedback(() -> Text.translatable("command.varhopper.get_int", "super_cooldown", ModConfig.INSTANCE.superCooldown), false);
