...
public abstract class VanillaHopperEntity extends LockableContainerBlockEntity implements Hopper, CoordinatedCooldown {
    ...
    public void pushAndPull(World world, BlockPos pos, BlockState state) {
        this.pushAndThen(world, pos, state, () -> this.pull(world, pos));
    }
    ...
    public void pushAndThen(World world, BlockPos pos, BlockState state, BooleanSupplier thenRun) {
        if (!state.get(VanillaHopperBlock.ENABLED)) {
            return;
        }
    ...
    public boolean pushIntoStorage(World world, BlockPos pos, BlockState state) {
        var dir = state.get(VanillaHopperBlock.FACING);
    ...
    public boolean pull(World world, BlockPos pos) {
